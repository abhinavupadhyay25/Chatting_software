...
public class Server implements ActionListener {
    ...
    Server(){
        ...
        ImageIcon img2=new ImageIcon(ClassLoader.getSystemResource("Chatting_App/icons/1.png"));
    ...
    public static void main(String[] args) {
        ...
        try {
            ServerSocket skv=new ServerSocket(60001);
            while (true){
                Socket soc=skv.accept();
